...
5. 🔴 **אין פירוט שירותים בעמוד הבית.** הקרוסלה מציגה שם
   ותמונה בלבד; כל ההסבר חי בעמודי המשנה → [[service-images]]
6. 🔴 **המשפט הפותח ב-hero לא נגעים בו**, וקופי דפי הנחיתה
...
- [תמונות השירותים](wiki/service-images.md) — שלושה תצלומים, ואיך מחליפים *(entity, 2026-09-06)*
...
- [x] ~~תצלום מוצר אמיתי של כרטיס ה-NFC~~ — הגיע 6.9, יחד עם
      תמונות לבוט ולגרף השיווק → [[service-images]]
...
- [ ] **משקל הדף: 1172KB ב-41 בקשות** אחרי גלילה מלאה (נמדד 6.9).
      שני chunks של 224KB ו-175KB הם עדיין החלק הגדול; שלוש
      תמונות השירותים הן 108KB בסך הכל. שווה בדיקה → [[performance]]
