...
2026-08-30 BUILD  הקרוסלה עברה לכרטיס אחד ברוחב כמעט מלא; החצים ירדו לשורת הנקודות בנייד → [[services-catalog]]
2026-08-30 DECIDE הכרטיס עצמו הפסיק להיות <a>. רק שם השירות מקשר, אחרת החלקה באצבע מסתיימת בניווט
2026-08-30 DROP   הטקסט המסביר ירד מכרטיסי הקרוסלה. ההסבר חי רק בעמוד השירות
2026-08-30 BUILD  חמישה איורים חדשים: כרטיס NFC פיזי, בוט עם לקוחות, מוקאפ אתר, גרף לפני/אחרי, כרטיס גוגל
2026-08-30 FIX    text-anchor מתהפך ב-SVG בתוך RTL; שם העסק דרס את האווטאר → [[svg-text-anchor-flips-in-rtl]]
2026-08-30 BUILD  נוסף npm run check:art שמודד bbox של כל טקסט באיור. הרצה ראשונה: 8 כשלים
2026-08-30 FIX    טוקני --art-* אוחדו לכלל אחד. ב-.feat__art הם לא היו מוגדרים והאיורים היו נעלמים בשקט
2026-08-30 BUILD  עמוד פרופיל גוגל קיבל השוואת לפני/אחרי → [[gbp-before-after]]
2026-08-30 DECIDE "מה אנחנו עושים" הוקדם לפני "העבודות שלנו", לבקשת הלקוח
```