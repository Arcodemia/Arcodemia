...
2026-09-06 BUILD  שלושה שירותים עברו מאיור מוטבע לתצלום: בוט, כרטיס NFC, גרף שיווק → [[service-images]]
2026-09-06 BUILD  נוסף tools/add-service-image.cjs — WebP ברוחב 1100 עם hash בשם. 3.4MB PNG → 108KB
2026-09-06 BUILD  ServiceVisual הוא נקודת ההחלטה היחידה בין תצלום לאיור; שלושת מקומות הקריאה עוברים דרכו
2026-09-06 DROP   AutomationArt, NfcArt ו-MarketingArt הוסרו יחד עם האנימציות שלהם — קוד שאין לו דרך לרוץ
2026-09-06 NOTE   התמונות סופקו בתיקיית ההורדות ולא בנתיב שצוין; זוהו לפי תוכן ואומתו מול התיאור
2026-09-06 NOTE   ההנחיה נקטעה באמצע סעיף 1; סעיפים 2 ו-3 (מבנה עמודי שירות, עדכוני קופי) לא הגיעו
2026-09-06 FIX    הרקע הלבן סביב כרטיס ה-NFC הוסר: חיתוך לגבולות הכרטיס + מסכת פינות מעוגלות, WebP עם אלפא
2026-09-06 DROP   שלושת חתכי הפירוט ירדו מעמוד הבית לבקשת הלקוח. Highlights.tsx נמחק
2026-09-06 BUILD  ServiceFeature: הפתיח המורחב עבר לראש עמודי אוטומציה/NFC/שיווק, עם heroArt כבוי
2026-09-06 DROP   הערת "תצלום זמני" בעמוד NFC ירדה, והתצלום האמיתי הגיע
```