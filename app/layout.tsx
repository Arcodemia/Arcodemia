...
const DESCRIPTION =
  'סוכנות דיגיטל לעסקים: אתרים, אוטומציות בוואטסאפ, קמפיינים ממומנים, כרטיסי NFC ופרופיל עסקי בגוגל. רואים את העבודה לפני שמשלמים.';
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'אז לא משלמים ולא ממשיכים. העיצוב הראשוני מוצג לפני כל תשלום בדיוק בשביל זה. אם הוא לא מדבר אליכם, נפרדים בטוב ובלי דמי ביטול.',
          },
        },
        {
          '@type': 'Question',
    ...
    >
      <body>
        ...
        <link
          rel="preload"
          as="image"
          href="/img/hero-wide.8d7a6b.webp"
        ...
        <link
          rel="preload"
          as="image"
          href="/img/hero-tall.0cd46a.webp"
